...
cartScene.enter(async (ctx) => {
    ...
    const [message, isEmpty] = await Cart.sendOverallCartMessage(ctx)//send the cart message
    Utils.updateCleanUpState(ctx, { id: message.message_id, type: "cart" })//update in the state
